/* global campus, infiniteScroll, wp */
...
Scroller.prototype.query = function() {
	...
	if( 'object' != typeof window.infiniteScroll )
		return {};
...
Scroller.prototype.refresh = function() {
	...
	if ( this.click_handle ) {
		loader = '<span class="infinite-loader">' + campus.loader + '</span>';
	...
	jqxhr.done( function( response ) {
			...
			if ( response.type == 'success' ) {
				...
				if ( type == 'click' ) {
					...
					self.disabled = true;
					self.body.addClass( 'infinity-end' ).removeClass( 'infinity-success' );
					self.body.trigger( 'smn-infinite-scroll-posts-end' ); /* Added by Siméon */
				}
 ...
 */
$( document ).on( 'ajaxloading', function() {
 ...
 * Ready, set, go!
 */
$( document ).on( 'ready ajaxready', function() {
